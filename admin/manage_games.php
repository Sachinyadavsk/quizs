                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <select class="form-control" name="type" id="categories_id" required>
                                            ...
                                            <option value="Puzzle_game">Puzzle Games</option>
                                        </select>
                                    </div>
                                    <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" name="short_desc" placeholder="Enter short description" class="form-control" required value="<?php echo $short_desc ?>">
                                    </div>
                                </div>
                            </div>
