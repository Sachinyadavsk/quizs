		  ...
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   ...
				   <h4 class="box-link"><a href="manage_blogs.php">Add Blog</a> </h4>
				   <h4 class="box-link"><a href="blog-images.php">More Blog Images</a> </h4>
				</div>
				<div class="card-body--">
...
function sendNotification($token,$description,$title,$icon_url,$action_url){
    ...
    $headers=array(
        'Authorization: key=AIzaSyD5N4gj7u8kK9Gj9I7h37dWBW9cO275tIE',
