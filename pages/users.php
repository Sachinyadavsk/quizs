                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                       <td class="align-middle"><?php echo $list['id'];?></td>
                                                        ...
                                                        <td class="align-middle">https://drive360.in/pages/landing-pages/<?php echo $aname;?>/<?php echo strtolower(trim(preg_replace('/[^A-Za-z0-9-]+/', '-', $list['name'])));?>/click_id/sub_id/</td>
